...
describe('StatusSlider', () => {
  ...
  it('should position the arrow based on an approximate version of networkCongestion', () => {
  ...
  it('should color the arrow and label based on an approximate version of networkCongestion', () => {
    const { getByTestId } = renderComponent({ networkCongestion: 0.23 });
